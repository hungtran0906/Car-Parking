...
typedef struct
{
	...
	volatile uint32_t CCMR1;   // Output Compare mode  (Different from input capture mode)
	volatile uint32_t CCMR2;   // Output Compare mode  (Different from input capture mode)
...
// RCC Reset Mechanism for I2C
#define RCC_I2C1_Reset()               (RCC->APB1RSTR |= 1<<21)
#define RCC_I2C2_Reset()               (RCC->APB1RSTR |= 1<<22)

// RCC Reset for TIMER2
#define RCC_TIMER2_CLK_Reset()         (RCC->APB1RSTR |= 1<<0)
...
// I2C
#define NVIC_IRQ31_I2C1_EV_Enable			(NVIC_ISER0 |= (1<<31))    // 31 in ISER0
#define NVIC_IRQ32_I2C1_ER_Enable			(NVIC_ISER1 |= (1<<0))    // 32-32
#define NVIC_IRQ33_I2C2_EV_Enable			(NVIC_ISER1 |= (1<<1))    // 33-32
#define NVIC_IRQ34_I2C2_ER_Enable			(NVIC_ISER1 |= (1<<2))    // 34-32
...
// I2C
#define NVIC_IRQ31_I2C1_EV_Disable			(NVIC_ICER0 |= (1<<31))    // 31 in ISER0
#define NVIC_IRQ32_I2C1_ER_Disable			(NVIC_ICER1 |= (1<<0))    // 32-32
#define NVIC_IRQ33_I2C2_EV_Disable			(NVIC_ICER1 |= (1<<1))    // 33-32
#define NVIC_IRQ34_I2C2_ER_Disable			(NVIC_ICER1 |= (1<<2))    // 34-32
